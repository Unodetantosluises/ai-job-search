...
exports.CommandsModule = CommandsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            setup_command_1.SetupConfirmQuestion,
            setup_command_1.SetupOverwriteConfirmQuestion,
            setup_command_1.SetupBehavioralQuestions,
            setup_command_1.SetupCareerQuestions,
