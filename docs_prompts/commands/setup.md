...
- `outcome.md`: status (in_progress/hired/offer_declined/rejected/no_response/interview_only), interview stages, notes. Skip `in_progress` applications for calibration â€” they have no final signal yet.
...
Then proceed to Step 3 to populate the non-skill files (`CLAUDE.md`, `cv/main_example.tex`, `docs_prompts/skills/job-scraper/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
...
### 8. Generate `docs_prompts/skills/job-scraper/search-queries.md`
...
> - `docs_prompts/skills/job-application-assistant/01-candidate-profile.md` - Structured profile
> - `docs_prompts/skills/job-application-assistant/02-behavioral-profile.md` - Behavioral assessment
> - `docs_prompts/skills/job-application-assistant/04-job-evaluation.md` - Personalized evaluation framework
> - `docs_prompts/skills/job-application-assistant/05-cv-templates.md` - CV templates with your profile statements
> - `docs_prompts/skills/job-application-assistant/07-interview-prep.md` - STAR examples from your experience
> - `cv/main_example.tex` - Your LaTeX CV template
> - `docs_prompts/skills/job-scraper/search-queries.md` - Job search queries for `/scrape`
>
> **Try it out:**
